...
// 		    $link=connectDBServer($config);
	...
	public	function procesar($proyecto,$config)
		{
	...
	public	function procesarDelete($proyecto)
		{
		    // Crear array out
		                    $out=array();
		                    foreach($_POST as $key => $value)
	...
	public	function readUsersById($link, $id)
		{
		    $sql="SELECT * FROM usuarios 
		                  WHERE idusuarios=".$id;
		            $result = query($link, $sql);
	...
	public	function readUserData($link, $proyecto)
		{
